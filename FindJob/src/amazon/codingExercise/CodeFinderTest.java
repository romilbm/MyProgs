...
public class CodeFinderTest {
    ...
    @Test
    public void testCabNearStaysNear(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabPositionChanged(new KCCab(1, true, new Position(-1,-1)));
    ...
    @Test
    public void testCabFarComesNear(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabPositionChanged(new KCCab(2, true, new Position(-1,-1)));

        Set<KCCab> expectedCabs = new HashSet<KCCab>();
        expectedCabs.add(new KCCab(1,true,new Position(1,1)));
        expectedCabs.add(new KCCab(8,true,new Position(3,3)));
        expectedCabs.add(new KCCab(2,true,new Position(-1,-1)));
    ...
    @Test
    public void testCabFarStaysFar(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabPositionChanged(new KCCab(2, true, new Position(40,40)));
    ...
    @Test
    public void testFarUnavailableIsAvailable(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabAvailabilityChanged(new KCCab(6, false, new Position(51,51)), true);
    ...
    @Test
    public void testNearAvailableIsUnavailable(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabAvailabilityChanged(new KCCab(1, true, new Position(1,1)), false);
    ...
    @Test
    public void testFarAvailableIsUnavailable(){
        CabFinder myCabFinder = new CabFinder();
        myCabFinder.initialize(kcCabApp,3);

        myCabFinder.onCabAvailabilityChanged(new KCCab(2, true, new Position(50,50)), false);
