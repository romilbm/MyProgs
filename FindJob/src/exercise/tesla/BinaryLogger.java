 ...
 * It does so in* such a way that it is possible to stream these instances back in an iterative fashion via
...
public interface BinaryLogger<T extends BinaryLoggable> extends Closeable
{
     ...
     * from which to read from* @param clazz a class of the type T, clazz should have a public no-arg constructor
     * @throws IOException if any IO operation fails
     */
